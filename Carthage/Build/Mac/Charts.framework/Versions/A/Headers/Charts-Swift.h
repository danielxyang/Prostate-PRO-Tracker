...
*/
- (NSColor * _Nonnull)colorAtIndex:(NSInteger)atIndex;
- (void)resetColors;
...
- (BOOL)gestureRecognizerShouldBeginWithGestureRecognizer:(NSGestureRecognizer * _Nonnull)gestureRecognizer;
...
*/
- (NSColor * _Nullable)getCircleColorAtIndex:(NSInteger)atIndex;
/**
