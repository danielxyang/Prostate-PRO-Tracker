...
//    public let numberOfSteps = 16
    ...
    var textChoices = [
        ORKTextChoice(text: "0-No Problem", value: NSNumber(value: 0)),
        ORKTextChoice(text: "1-Very small problem", value: NSNumber(value: 1)),
        ORKTextChoice(text: "2-Small problem", value: NSNumber(value: 2)),
        ORKTextChoice(text: "3-Moderate problem", value: NSNumber(value: 3)),
        ORKTextChoice(text: "4-Big problem", value: NSNumber(value: 4))
    ]
    ...
    textChoices = [
        ORKTextChoice(text: "0-Total control", value: NSNumber(value: 0)),
        ORKTextChoice(text: "1-Occasional dribbling", value: NSNumber(value: 1)),
        ORKTextChoice(text: "2-Frequent dribbling", value: NSNumber(value: 2)),
        ORKTextChoice(text: "4-No urinary control", value: NSNumber(value: 4))
    ]
    ...
    textChoices = [
        ORKTextChoice(text: "0-None", value: NSNumber(value: 0)),
        ORKTextChoice(text: "1-One pad per Day", value: NSNumber(value: 1)),
        ORKTextChoice(text: "2-Two pads per Day", value: NSNumber(value: 2)),
        ORKTextChoice(text: "4-Three or more pads", value: NSNumber(value: 4))
    ]
    answerFormat = ORKAnswerFormat.choiceAnswerFormat(with: .singleChoice, textChoices: textChoices)
    ...
    textChoices = [
        ORKTextChoice(text: "0-Very Good", value: NSNumber(value: 0)),
        ORKTextChoice(text: "1-Good", value: NSNumber(value: 1)),
        ORKTextChoice(text: "2-Fair", value: NSNumber(value: 2)),
        ORKTextChoice(text: "3-Poor", value: NSNumber(value: 3)),
        ORKTextChoice(text: "4-Very poor to none", value: NSNumber(value: 4))
    ]
    answerFormat = ORKAnswerFormat.choiceAnswerFormat(with: .singleChoice, textChoices: textChoices)
    ...
    textChoices = [
        ORKTextChoice(text: "0-Firm enough for intercourse", value: NSNumber(value: 0)),
        ORKTextChoice(text: "1-firm enough for masturbation and foreplay", value: NSNumber(value: 1)),
        ORKTextChoice(text: "2-Not firm enough for any sexual activity", value: NSNumber(value: 2)),
        ORKTextChoice(text: "4-None at all", value: NSNumber(value: 4))
    ]
    answerFormat = ORKAnswerFormat.choiceAnswerFormat(with: .singleChoice, textChoices: textChoices)
