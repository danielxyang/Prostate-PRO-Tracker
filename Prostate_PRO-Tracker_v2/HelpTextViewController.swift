...
//        load the text (with bold words and "body" style)
        ...
        attString.append(NSMutableAttributedString(string: "Prostate PRO-Tracker", attributes: [NSFontAttributeName : boldFont]))
        attString.append(NSMutableAttributedString(string: " (the PRO stands for Patient-Reported Outcomes) to record your prostate cancer symptoms. Your input will help doctors better understand how patients feel during their prostate cancer treatment. ", attributes: [NSFontAttributeName : normalFont]))
        attString.append(NSMutableAttributedString(string: "Prostate PRO-Tracker", attributes: [NSFontAttributeName : boldFont]))
        attString.append(NSMutableAttributedString(string: " is part of a clinical study run by Yale University researchers.\n\nThe application is easy to use. Simply complete the following steps:", attributes: [NSFontAttributeName : normalFont]))
        ...
        attString.append(NSMutableAttributedString(string: "Consent", attributes: [NSFontAttributeName : boldFont]))
        attString.append(NSMutableAttributedString(string: " button and follow the instruction on the screen. Please review all information carefully.", attributes: [NSFontAttributeName : normalFont]))
        ...
        attString.append(NSMutableAttributedString(string: "Respond", attributes: [NSFontAttributeName : boldFont]))
        attString.append(NSMutableAttributedString(string: " button to enter your responses to a short clinical survey about your prostate cancer symptoms. You are able to respond as often as you’d like. We encourage you to respond often – even daily! If you have not responded in a week, the app will send you a reminder.", attributes: [NSFontAttributeName : normalFont]))
        ...
        attString.append(NSMutableAttributedString(string: "Get Involved", attributes: [NSFontAttributeName : boldFont]))
        attString.append(NSMutableAttributedString(string: " button to volunteer more information about yourself, such as your age, ethnicity, and type of treatment received for your cancer. You are able skip any questions or say \"I don’t know.\"", attributes: [NSFontAttributeName : normalFont]))
        ...
        attString.append(NSMutableAttributedString(string: "Track Results", attributes: [NSFontAttributeName : boldFont]))
        attString.append(NSMutableAttributedString(string: " button to see graphs of how your responses have changed over time (lower score means fewer symptoms). The green bar indicates your reported symptoms of a specific type/domain, while the orange line indicates the sum total of your responses across all symptoms.\n\n\n\nTo protect your information, we recommend that you use a passcode on your iOS device while this application is installed.\n\nThat’s it! We look forward to your participation!", attributes: [NSFontAttributeName : normalFont]))
